...
func seedExercises() {
	type exercise struct {
		...
		ImageURL, GifURL             string
	}

	const (
		fedb = "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/"
	...
	exercises := []exercise{
		...
		{Name: "Bench Press", Group: "chest", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Barbell_Bench_Press_-_Medium_Grip/0.jpg",
			GifURL:       fedb + "Barbell_Bench_Press_-_Medium_Grip/1.jpg",
		},
		{Name: "Incline Dumbbell Press", Group: "chest", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Incline_Dumbbell_Press/0.jpg",
			GifURL:       fedb + "Incline_Dumbbell_Press/1.jpg",
		},
		{Name: "Dumbbell Fly", Group: "chest", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Dumbbell_Flyes/0.jpg",
			GifURL:       fedb + "Dumbbell_Flyes/1.jpg",
		},
		{Name: "Push-ups", Group: "chest", Equipment: "Bodyweight",
			...
			ImageURL:     fedb + "Pushups/0.jpg",
			GifURL:       fedb + "Pushups/1.jpg",
		},
		// ── Back ───────────────────────────────────────────────────
		{Name: "Deadlift", Group: "back", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Barbell_Deadlift/0.jpg",
			GifURL:       fedb + "Barbell_Deadlift/1.jpg",
		},
		{Name: "Pull-ups", Group: "back", Equipment: "Bodyweight",
			...
			ImageURL:     fedb + "Chin-Up/0.jpg",
			GifURL:       fedb + "Chin-Up/1.jpg",
		},
		{Name: "Barbell Row", Group: "back", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Bent_Over_Barbell_Row/0.jpg",
			GifURL:       fedb + "Bent_Over_Barbell_Row/1.jpg",
		},
		{Name: "Lat Pulldown", Group: "back", Equipment: "Cable",
			...
			ImageURL:     fedb + "Wide-Grip_Lat_Pulldown/0.jpg",
			GifURL:       fedb + "Wide-Grip_Lat_Pulldown/1.jpg",
		},
		// ── Legs ───────────────────────────────────────────────────
		{Name: "Squat", Group: "legs", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Barbell_Squat/0.jpg",
			GifURL:       fedb + "Barbell_Squat/1.jpg",
		},
		{Name: "Romanian Deadlift", Group: "legs", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Romanian_Deadlift/0.jpg",
			GifURL:       fedb + "Romanian_Deadlift/1.jpg",
		},
		{Name: "Leg Press", Group: "legs", Equipment: "Machine",
			...
			ImageURL:     fedb + "Leg_Press/0.jpg",
			GifURL:       fedb + "Leg_Press/1.jpg",
		},
		{Name: "Calf Raise", Group: "legs", Equipment: "Machine",
			...
			ImageURL:     fedb + "Barbell_Seated_Calf_Raise/0.jpg",
			GifURL:       fedb + "Barbell_Seated_Calf_Raise/1.jpg",
		},
		{Name: "Front Squat", Group: "legs", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Barbell_Full_Squat/0.jpg",
			GifURL:       fedb + "Barbell_Full_Squat/1.jpg",
		},
		{Name: "Bulgarian Split Squat", Group: "legs", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Barbell_Lunge/0.jpg",
			GifURL:       fedb + "Barbell_Lunge/1.jpg",
		},
		// ── Shoulders ──────────────────────────────────────────────
		{Name: "Overhead Press", Group: "shoulders", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Barbell_Shoulder_Press/0.jpg",
			GifURL:       fedb + "Barbell_Shoulder_Press/1.jpg",
		},
		{Name: "Lateral Raise", Group: "shoulders", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Side_Lateral_Raise/0.jpg",
			GifURL:       fedb + "Side_Lateral_Raise/1.jpg",
		},
		{Name: "Face Pull", Group: "shoulders", Equipment: "Cable",
			...
			ImageURL:     fedb + "Face_Pull/0.jpg",
			GifURL:       fedb + "Face_Pull/1.jpg",
		},
		// ── Arms ───────────────────────────────────────────────────
		{Name: "Bicep Curl", Group: "arms", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Dumbbell_Bicep_Curl/0.jpg",
			GifURL:       fedb + "Dumbbell_Bicep_Curl/1.jpg",
		},
		{Name: "Tricep Pushdown", Group: "arms", Equipment: "Cable",
			...
			ImageURL:     fedb + "Cable_Incline_Triceps_Extension/0.jpg",
			GifURL:       fedb + "Cable_Incline_Triceps_Extension/1.jpg",
		},
		{Name: "Hammer Curl", Group: "arms", Equipment: "Dumbbell",
			...
			ImageURL:     fedb + "Alternate_Hammer_Curl/0.jpg",
			GifURL:       fedb + "Alternate_Hammer_Curl/1.jpg",
		},
		{Name: "Skull Crusher", Group: "arms", Equipment: "Barbell",
			...
			ImageURL:     fedb + "Lying_Triceps_Press/0.jpg",
			GifURL:       fedb + "Lying_Triceps_Press/1.jpg",
		},
		// ── Core ───────────────────────────────────────────────────
		{Name: "Plank", Group: "core", Equipment: "Bodyweight",
			...
			ImageURL:     fedb + "Plank/0.jpg",
			GifURL:       fedb + "Plank/1.jpg",
		},
		{Name: "Hanging Leg Raise", Group: "core", Equipment: "Bodyweight",
			...
			ImageURL:     fedb + "Hanging_Leg_Raise/0.jpg",
			GifURL:       fedb + "Hanging_Leg_Raise/1.jpg",
		},
		// ── Cardio ─────────────────────────────────────────────────
		{Name: "Running (Treadmill)", Group: "cardio", Equipment: "Machine",
			...
			ImageURL:     uns + "1576678927484-cc8c72af622c?w=400&h=300&fit=crop",
			GifURL:       uns + "1576678927484-cc8c72af622c?w=400&h=300&fit=crop",
		},
		{Name: "Jump Rope", Group: "cardio", Equipment: "Bodyweight",
			...
			ImageURL:     uns + "1538805060514-97d9a109c276?w=400&h=300&fit=crop",
			GifURL:       uns + "1538805060514-97d9a109c276?w=400&h=300&fit=crop",
		},
		{Name: "Burpees", Group: "cardio", Equipment: "Bodyweight",
			...
			ImageURL:     uns + "1601422400983-53c327428487?w=400&h=300&fit=crop",
			GifURL:       uns + "1601422400983-53c327428487?w=400&h=300&fit=crop",
		},
		{Name: "Rowing Machine", Group: "cardio", Equipment: "Machine",
			...
			ImageURL:     fedb + "Rowing_Stationary/0.jpg",
			GifURL:       fedb + "Rowing_Stationary/1.jpg",
		},
	}
	...
	for i, ex := range exercises {
		...
		database.DB.Exec(`
			INSERT OR IGNORE INTO exercises (id, name, muscle_group, equipment, description, instructions, tips, common_mistakes, image_url, gif_url, created_at)
			VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'))
		`, realID, ex.Name, ex.Group, ex.Equipment, ex.Desc, instJSON, tipsJSON, mistakesJSON, ex.ImageURL, ex.GifURL)
	}
}
